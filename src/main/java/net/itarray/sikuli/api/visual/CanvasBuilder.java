...
import net.itarray.sikuli.api.Location;
import net.itarray.sikuli.api.Region;
import net.itarray.sikuli.api.visual.element.*;
import net.itarray.sikuli.api.visual.element.Element.HorizontalAlignment;
import net.itarray.sikuli.api.visual.element.Element.VerticalAlignment;
