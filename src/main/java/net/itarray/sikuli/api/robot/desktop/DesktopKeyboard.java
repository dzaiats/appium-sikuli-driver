package net.itarray.sikuli.api.robot.desktop;

import net.itarray.sikuli.api.ScreenLocation;
import net.itarray.sikuli.api.ScreenRegion;
import net.itarray.sikuli.api.robot.Env;
import net.itarray.sikuli.api.robot.Keyboard;
import net.itarray.sikuli.api.robot.Mouse;
